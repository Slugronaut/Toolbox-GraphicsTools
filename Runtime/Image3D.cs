...
namespace Peg.Graphics
{
    ...
    public class Image3D : Graphic
    {
        ...
        /// </summary>
        [ShowInInspector]
        [PropertyTooltip("The 3D mesh to display within the confines of the RectTransform.")]
        [XmlIgnore]
        public Mesh Mesh
        {
            get { return _Mesh; }
        ...
        [PropertyTooltip("Color tint of the model.")]
        [XmlIgnore]
        public Color Color { get { return base.color; } set { base.color = value; } }

        [ShowInInspector]
        [PropertyTooltip("The material applied to the model.")]
        [XmlIgnore]
